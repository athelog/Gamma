...
%trainCascadeObjectDetector('stopSignDetector.xml',positiveInstances, ...
 ...
 trainCascadeObjectDetector('CarToView.xml',positiveInstances, ...
...
detector = vision.CascadeObjectDetector('CarToView.xml');
%%
