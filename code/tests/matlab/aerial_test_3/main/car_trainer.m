...
function o = Car_Sedan_Top_Medium_Training()
    ...
    load('..\labelling\vehicles\sedan_top_medium.mat'); %load labelling session    
    trainCascadeObjectDetector('sedan_top_medium.xml',positiveInstances_sedan_top_medium, ... %training call
        negativeImages,'FalseAlarmRate',0.15,'NumCascadeStages',11); %
